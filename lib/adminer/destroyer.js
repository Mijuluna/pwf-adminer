		...
		mod = {
			...
			'proto':{
				...
				'construct':function(proto) {
					...
					el.create_divs(['heading', 'desc', 'rels', 'buttons']);
				...
				'create_heading':function() {
					...
					el.heading.html(pwf.locales.trans('adminer-delete-model-object', {
				...
				'create_desc':function() {
					...
					el.desc.html(pwf.locales.trans('adminer-delete-model-object-desc'));
				},
